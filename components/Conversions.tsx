...
export const Conversions: React.FC<ConversionsProps> = () => {
    const { t } = useLocalization();
    
    return (
        <div className="p-6">
            <h2 className="text-3xl font-bold text-neutral mb-6">{t('conversions')}</h2>
            <div className="bg-white rounded-xl shadow-lg overflow-hidden p-8 text-center">
                <h3 className="text-xl font-bold text-neutral">{t('conversions')}</h3>
